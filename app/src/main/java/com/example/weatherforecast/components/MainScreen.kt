        ...
        LazyColumn(
            ...
            if (hasError) {
                ...
                item {
                    ...
                    WeatherUtils.WeatherHeader(text = context.resources.getString(R.string.weather_24_hour))
                }
                item {
                ...
                item {
                    Spacer(modifier = Modifier.height(8.dp))
                    WeatherUtils.WeatherHeader(text = context.resources.getString(R.string.weather_7_days))
                }
                item {
                    ForecastWeatherList(
                ...
                item{
                    HorizontalDivider()
                    Spacer(modifier = Modifier.height(8.dp))
                    WeatherUtils.WeatherHeader(text = context.getString(R.string.daily_weather_forecast))
                    Spacer(modifier = Modifier.height(8.dp))
                }
